			...
			<div class="am-topbar-right">
				...
				<%if Session("username")="" Then%>
					...
					<a href="../view/admin.asp">
						<button class="am-btn am-btn-primary am-topbar-btn am-btn-sm">管理</button>
					</a>
					<%else %>
						<a href="#msg">
							<button class="am-btn am-btn-primary am-topbar-btn am-btn-sm" data-am-modal="{target: '#addmsg'}">添加留言</button>
						</a>
